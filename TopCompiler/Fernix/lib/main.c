...
void _global_log_Type(struct _global_Type _global_s, struct _global_Context* c);
...
;}
void _global_log_Type(struct _global_Type _global_s, struct _global_Context* c){;
_global_c_log(_global_Type_toString(&(_global_s),c),c);
;}
...
_global_log_Type(main_typ_of_s,(&_global_context));
