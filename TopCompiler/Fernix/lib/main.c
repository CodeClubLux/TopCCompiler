...
;}
struct _global_StaticArray_4_materialSystem_Param main_wet_street_params;struct model_Model main_cube;struct _global_StaticArray_StaticArray_S_materialSystem_Param tmpmainbX(struct _global_StaticArray_4_materialSystem_Param* c) {
...
main_cube = model_load_model(_global_StringInit(15,"assets/cube.fbx"),tmpprimitivesJ(_global_box__1_materialSystem_Material(_global_StaticArray_1_materialSystem_MaterialInit(materialSystem_MaterialInit(_global_StringInit(15,"DefaultMaterial"),shader_make(_global_StringInit(23,"assets/shaders/pbr.vert"),_global_StringInit(23,"assets/shaders/pbr.frag"),(&_global_context)),tmpmainbX(&(main_wet_street_params)))),(&_global_context))),(&_global_context));;
