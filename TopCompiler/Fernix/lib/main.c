struct _global_StaticArray_4_materialSystem_Param main_wet_street_params;struct materialSystem_Material* main_wet_street;struct _global_StaticArray_StaticArray_S_materialSystem_Param tmpmainbz(struct _global_StaticArray_4_materialSystem_Param* b) {
...
main_wet_street = _global_box_materialSystem_Material(materialSystem_MaterialInit(_global_StringInit(15,"DefaultMaterial"),shader_make(_global_StringInit(23,"assets/shaders/pbr.vert"),_global_StringInit(23,"assets/shaders/pbr.frag"),(&_global_context)),tmpmainbz(&(main_wet_street_params))),(&_global_context));;
