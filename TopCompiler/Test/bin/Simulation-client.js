...
function html_clientInit(){var d=0;return function c(b){while(1){switch (d){case 0:html__onUrlChange = _html_onUrlChange;html_setUrl = _html_setUrl;html_setLocalStorage = _html_setLocalStorage;html_readLocalStorage = _html_readLocalStorage;html_pageLoadUrl = window.location.hash.slice(1);html_nextTick = _nextTick;html_style = html_newAttrib.bind(null,"style");html_placeHolder = html_newAttrib.bind(null,"placeholder");html_position = html_newAttrib.bind(null,"position");html__type = html_newAttrib.bind(null,"type");html_height = html_newAttrib.bind(null,"height");html_width = html_newAttrib.bind(null,"width");html_id = html_newAttrib.bind(null,"id");html_min = html_newAttrib.bind(null,"min");html_max = html_newAttrib.bind(null,"max");html_step = html_newAttrib.bind(null,"step");html_value = html_newAttrib.bind(null,"value");html_href = html_newAttrib.bind(null,"href");html_src = html_newAttrib.bind(null,"src");html_kind = html_newAttrib.bind(null,"type");html__float = html_newAttrib.bind(null,"float");html_class = html_newAttrib.bind(null,"className");html_onClick = html_onEvent.bind(null,"onclick");html_onInput = html_onEvent.bind(null,"oninput");html_onChange = html_onEvent.bind(null,"onchange");html_h = fromJS(html_hyper);html_createElement = virtualDom.create;html_diff = virtualDom.diff;html_patch = toAsync(virtualDom.patch);html_clear = toAsync(clearElement);html_cssSelector = document.querySelector.bind(document);html_h1 = html_h.bind(null,"h1");html_h2 = html_h.bind(null,"h2");html_h3 = html_h.bind(null,"h3");html_h4 = html_h.bind(null,"h4");html_h5 = html_h.bind(null,"h5");html_h6 = html_h.bind(null,"h6");html_br = html_h.bind(null,"br");html_hr = html_h.bind(null,"hr");html_button = html_h.bind(null,"button");html_input = html_h.bind(null,"input");html_noAttrib = EmptyVector;html_div = html_h.bind(null,"div");html_p = html_h.bind(null,"p");html_ul = html_h.bind(null,"ul");html_li = html_h.bind(null,"li");html_a = html_h.bind(null,"a");html_image = html_h.bind(null,"img");html_span = html_h.bind(null,"span");html__appendChild = toAsync(html_appendChild);html__handle = html_handle;html_animateOnVisible = html_addClassOnVisible;return;}}}()}function html_PosAtom(c,d){this.a=c;this.pos=d;}html_PosAtom.fields=["a","pos"];html_PosAtom.prototype.unary_read=(function(c){return html_PosAtom_unary_read(this,c)});function html_PosAtom_unary_read(d,f){var j=0;return function h(g){while(1){switch(j){case 0:j=1;return (d).a.unary_read(h);case 1:;return f(((d).pos).query(g));}}}()}html_PosAtom.prototype.operator_set=(function(c,d){return html_PosAtom_operator_set(this,c,d)});function html_PosAtom_operator_set(f, g,h){var l=0;return function k(j){while(1){switch(l){case 0:l=2;return (f).a.unary_read(k);case 2:;l=3;return ((f).a).operator_set(((f).pos).set(j,g),k);case 3:return h(j);}}}()}html_PosAtom.prototype.watch=(function(c,d){return html_PosAtom_watch(this,c,d)});function html_PosAtom_watch(f, g,h){var l=0;return function k(j){while(1){switch(l){case 0:function m(n,p){var s=0;return function r(q){while(1){switch(s){case 0:s=4;return (f).a.unary_read(r);case 4:;s=5;return g(((f).pos).query(q),r);case 5:return p(q);}}}()}l=6;return ((f).a).watch(m,k);case 6:return h(j);}}}()}function html_Event(c){this.target=c;}html_Event.fields=["target"];function html_Attribute(c,d){this.name=c;this.value=d;}html_Attribute.fields=["name","value"];function html_newAttrib(c, d){return new html_Attribute(c,d,d);}function html_onEvent(c, d, f){function g(h,j){var m=0;return function l(k){while(1){switch(m){case 0:m=7;return f.unary_read(l);case 7:;m=8;return d(k,h,l);case 8:m=9;return (f).operator_set(k,l);case 9:return j(k);}}}()}return new html_Attribute(c,g,g);}function html_onUrlChange(c, d,f){var j=0;return function h(g){while(1){switch(j){case 0:function k(l,m){var q=0;return function p(n){while(1){switch(q){case 0:q=10;return d.unary_read(p);case 10:;q=11;return c(n,l,p);case 11:q=12;return (d).operator_set(n,p);case 12:return m(n);}}}()}j=13;return html__onUrlChange(k,h);case 13:return f(g);}}}()}function html_async(c, d){function f(g){var k=0;return function j(h){while(1){switch(k){case 0:k=14;return d.unary_read(j);case 14:;k=15;return c(h,j);case 15:k=16;return (d).operator_set(h,j);case 16:return g(h);}}}()}return f;}function html_ignoreAct(c){function d(f, g,h){var l=0;return function k(j){while(1){switch(l){case 0:l=17;return c(f,k);case 17:return h(j);}}}()}return d;}function html_withId(c){function d(f, g, h,j){var n;var m=0;return function l(k){while(1){switch(m){case 0:m=18;return c(g.get(f),h,l);case 18:n = (k);return j((g).set(f,n));}}}()}return d;}function html_mapWithId(c, d, f){function g(h){return c(d.get(h),h,f);}return (newVectorRange(0,(d).length)).map(g);}function html_mapView(c, d, f){function g(h){var j;j = d.get(h);var k;k = newLens(function(l){return l.get(h)}, function(m,l){return m.set(h,l)});var n;n = new html_PosAtom(f,k,k);return c(j,n);}return (newVectorRange(0,(d).length)).map(g);}function html_viewFromLens(c, d, f, g){return c(((f).query(d)),new html_PosAtom(g,f,f));}function html_render(c,d){var j;var k;var h=0;return function g(f){while(1){switch(h){case 0:j = html_createElement(c);k = html_cssSelector("#code");h=19;return html__appendChild(k,j,g);case 19:return d(j);}}}()}function html_get(c){var g=0;return function f(d){while(1){switch(g){case 0:return c();}}}()}function html_app(c, d,f){var k;var l;var j=0;return function h(g){while(1){switch(j){case 0:j=20;return d.unary_read(h);case 20:;k = c((g),d);j=21;return html_get(h);case 21:j=22;return html_render(k,h);case 22:l = g;function m(n,p){var t;var v;var s=0;return function r(q){while(1){switch(s){case 0:t = c(n,d);v = html_diff(k,t);s=23;return html_patch(l,v,r);case 23:l=q;html__handle();k=t;return p();}}}()}j=24;return (d).watch(m,h);case 24:return f(g);}}}()}function main_clientInit(){var d=0;return function c(b){while(1){switch (d){case 0:http_clientInit();main_headers = newVector("HOME","EXAMPLES","DOCS","COMMUNITY","BLOG");main_footer_text = "All code for this site is written in Top, including the server - Lucas Goetz";db_clientInit();html_clientInit();main_names = newVector("HOME","CUSTOM BUILDS","ABOUT");d=42;return main_main(html_pageLoadUrl,c);case 42:main_appState = newAtom(b);d=52;return html_onUrlChange(main_onNewUrl,main_appState,c);case 52:d=53;return html_app(main_render,main_appState,c);case 53:return;}}}()}function main_Feature(c,d,f,g){this.id=c;this.name=d;this.description=f;this.image=g;}main_Feature.fields=["id","name","description","image"];function main_Part(c,d,f,g,h,j){this.kind=c;this.name=d;this.rating=f;this.price=g;this.other=h;this.image=j;}main_Part.fields=["kind","name","rating","price","other","image"];main_Feature.prototype.toString=(function(){return main_Feature_toString(this)});function main_Feature_toString(c){return (((((((((((("Feature(")+(((c).id)).toString()))+(",").toString()))+(((c).name)).toString()))+(",").toString()))+(((c).image)).toString()))+(")").toString());}function main_PartsPage(c,d,f){this.parts=c;this.headers=d;this.kind=f;}main_PartsPage.fields=["parts","headers","kind"];function main_Home(c,d,f){this.features=c;this.headers=d;this.footer=f;}main_Home.fields=["features","headers","footer"];function main_Docs(c,d,f,g,h){this.overview=c;this.learn=d;this.packages=f;this.headers=g;this.footer=h;}main_Docs.fields=["overview","learn","packages","headers","footer"];function main_Kind(c,d,f){this.name=c;this.image=d;this.selected=f;}main_Kind.fields=["name","image","selected"];function main_PageHome(f){return [0,f]}function main_PageDocs(g){return [1,g]}function main_PageKinds(h){return [2,h]}function main_PageParts(j){return [3,j]}var main_PageAbout=[4,];function main_PagePart(k){return [5,k]}var main_PageNotFound=[6,];var main_PageGetStarted=[7,];main_Part.prototype.toString=(function(){return main_Part_toString(this)});function main_Part_toString(c){return (((((((((((((((((((("Part(")+(((c).kind)).toString()))+(", ").toString()))+(((c).name)).toString()))+(", ").toString()))+(((c).rating)).toString()))+(" stars, $").toString()))+(((c).price)).toString()))+(", ").toString()))+(((c).other)).toString()))+(")").toString());}function main_QueryDocs(l){return [0,l]}function main_QueryParts(m,n,p){return [1,m,n,p]}function main_QueryPart(q,r){return [2,q,r]}function main_map(c, d){return (d).map(c);}function main_filter(c, d){return (d).filter(c);}function main_reduce(c, d){return (d).reduce(c);}function main_comp(c, d){return c(d);}function main_zip(c, d){var f;f = EmptyVector;var g;g = 0;
while((g<(c).length)){f=(f).append((newVector(c.get(g),d.get(g))));g=((g+1)|0);}return f;}function main_append(c, d){return (d).append(c);}function main_first(c){return c.get(0);}function main_toEffect(c){function d(f,g){var k=0;return function j(h){while(1){switch(k){case 0:return g(c(f));}}}()}return d;}function main_main(c,d){var j;var k;var l;var m;var n;var p;var q;var r;var s;var t;var v;var h=0;return function g(f){while(1){switch(h){case 0:var w=c; if (w==""||w=="HOME"){f=main_PageHome(new main_Home(EmptyVector,main_names,"The Enigma-computers team wishes you the best","The Enigma-computers team wishes you the best"));h=32;/*block*/break;}/*if*/case 33:/*notif*/ if (w=="ABOUT"){f=main_PageAbout;h=32;/*block*/break;}/*if*/case 34:/*notif*/ if (w=="CUSTOM BUILDS"){h=35;return html_readLocalStorage(core_json_vector(core_json_struct(main_Kind,[['selected',core_json_enum([[core_json_struct(main_Part,[['image',core_json_string],['price',core_json_float],['kind',core_json_string],['rating',core_json_int],['name',core_json_string],['other',core_json_vector(core_json_interface([['value',core_json_string],['name',core_json_string],]))],])],[],])],['image',core_json_string],['name',core_json_string],])),g);}/*case*/h=36;break;/*case*/case 35:j = f;f=function(){var x=j; if (x[0]==0){var y=x[1];return main_PageKinds({headers:main_names,kinds:y});} if (x[0]==1){n = None;return main_PageKinds({headers:main_names,kinds:newVector(new main_Kind("CPU","https://www.tutorialspoint.com/computer_fundamentals/images/cpu.jpg",n,n),new main_Kind("CPU COOLER","https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRh-2GiRrYLj2t2uirg_eyPrBPM3zIy9YOtcuH3Xb8io4m3tNFjOQ",n,n),new main_Kind("MOTHERBOARD","http://media.gamersnexus.net/images/media/2014/guides/asus-rog-hero.png",n,n))});}}();h=32;/*block*/break;/*if*/case 36:/*notif*/var z=new RegExp('CUSTOM BUILDS/CPU/(.*)').exec(w);if (z){p=z[1];t = parseJson.bind(null,core_json_struct(main_Part,[['image',core_json_string],['price',core_json_float],['kind',core_json_string],['rating',core_json_int],['name',core_json_string],['other',core_json_vector(core_json_interface([['value',core_json_string],['name',core_json_string],]))],]));h=37;return http_query(t,main_QueryPart.bind(null,p),g);}/*case*/h=38;break;/*case*/case 37:f=main_PagePart({headers:main_names,p:f});h=32;/*block*/break;/*if*/case 38:/*notif*/var B=new RegExp('KIND/(.*)').exec(w);if (B){r=B[1];log((((("routing ")+((r)).toString()))+("").toString()));s = core_json_vector(core_json_struct(main_Part,[['image',core_json_string],['price',core_json_float],['kind',core_json_string],['rating',core_json_int],['name',core_json_string],['other',core_json_vector(core_json_interface([['value',core_json_string],['name',core_json_string],]))],]));t = parseJson.bind(null,s);h=39;return http_query(t,main_QueryParts.bind(null,r,""),g);}/*case*/h=40;break;/*case*/case 39:v = f;f=main_PageParts(new main_PartsPage(v,main_names,r,r));h=32;/*block*/break;/*if*/case 40:/*notif*/ if (1){f=main_PageNotFound;h=32;/*block*/break;}case 32:return d(f);}}}()}function main_onNewUrl(c, d,f){var j=0;return function h(g){while(1){switch(j){case 0:j=41;return main_main(d,h);case 41:return f(g);}}}()}function main_navBar(c, d){var f;f = "border-style: solid; border-radius: 6px;     border-width: 1px; border-color: #CA343D;     margin: 10px;     width: 130px;     ";function g(h){var j;j = (function(){if((h===d)){return (f+"background-color: #CA343D;");}
else{return f;}})();return html_li(newVector(html_class("nav-bar-enigma"),html_style(j)),html_a(newVector(html_class("nav-bar-enigma"),html_style("font-size: 12px; padding: 10px;"),html_href(("#"+h))),h));}return html_ul(newVector(html_class("nav-bar-enigma")),(c).map(g));}function main_home(c, d){return main_background(newVector(main_navBar(main_names,"HOME"),html_image(newVector(html_src("enigma.png"),html_style("height: 70%; width: auto; display: block; margin-left: auto; margin-right: auto")),""),html_h2(newVector(html_style("width: 100%; text-align: center; color: white;")),"Building the best custom PC's for you")));}function main_background(c){return html_div(EmptyVector,newVector(html_div(newVector(html_class("enigma-background")),""),html_div(newVector(html_style("width: 100%; height: 100%; position: relative;")),c)));}function main_kinds(c, d){function f(g){var h;h = function(){var j=(g).selected; if (j[0]==0){var k=j[1];return html_div(newVector(html_class("kind")),html_a(newVector(html_style("font-size: 27px; color: black; width: 100%; position: absolute; text-align: center; text-decoration: none;"),html_href(("#KIND/"+(g).name))),newVector(html_p(newVector(html_class("link"),html_style("margin-bottom: 5px; margin-top: 5px; font-size: 27px;")),((g).name+"S")),html_a(newVector(html_href((((((((("#CUSTOM BUILDS/")+(((k).kind)).toString()))+("/").toString()))+(((k).name)).toString()))+("").toString()))),html_image(newVector(html_style("max-width: 130px; max-height: 130px;"),html_src((k).image)),"")))));} if (j[0]==1){return html_div(newVector(html_class("kind red")),html_a(newVector(html_style("text-decoration: none; font-size: 27px; color: black; text-align: center; width: 100%; vertical-align: middle; line-height: 160px; position: absolute;"),html_href(("#KIND/"+(g).name))),((g).name+"S")));}}();return html_li(newVector(html_style("color: white; display: inline;")),h);}return main_background(newVector(main_navBar((c).headers,"CUSTOM BUILDS"),html_span(EmptyVector,""),html_a(newVector(html_href("#CHECKOUT")),html_image(newVector(html_src("https://image.flaticon.com/icons/png/512/2/2772.png"),html_style("float: right; width: 40px; height: 40px; filter: invert(100%); margin-top: 32px; padding-right: 10%;")),"")),html_h1(newVector(html_style("color: white; width: 100%; margin-left: 15%; font-size: 40px;")),"Individual Parts"),html_ul(newVector(html_style("position: relative; width: 90%; margin-left: 10%;")),((c).kinds).map(f))));}function main_rating(c){return html_div(newVector(html_style("color: gold; font-size: 20px; float: right; display: inline; margin-left: 10px;")),newVectorInit(c,"★"));}function main_search(c, d,f){var k;var l;var m;var n;var p;var q;var j=0;return function h(g){while(1){switch(j){case 0:var r=c; if (r[0]==3){l=r[1];m = ((d).target).value;log(m);n = core_json_vector(core_json_struct(main_Part,[['image',core_json_string],['price',core_json_float],['kind',core_json_string],['rating',core_json_int],['name',core_json_string],['other',core_json_vector(core_json_interface([['value',core_json_string],['name',core_json_string],]))],]));p = parseJson.bind(null,n);j=44;return http_query(p,main_QueryParts.bind(null,(l).kind,m),h);}/*case*/j=45;break;/*case*/case 44:q = g;g=main_PageParts(new main_PartsPage(q,(l).headers,(l).kind,(l).kind));j=43;/*block*/break;/*if*/case 45:/*notif*/ if (1){g=c;j=43;/*block*/break;}case 43:return f(g);}}}()}function main_parts(c, d){function f(g){return html_li(newVector(html_class("part")),html_a(newVector(html_href(((("#CUSTOM BUILDS/"+(c).kind)+"/")+(g).name)),html_style("text-decoration: none; elementoverflow: hidden;")),newVector(html_span(newVector(html_class("link")),(g).name),html_span(newVector(html_class("link"),html_style("text-decoration: none; margin-left: 30px;")),("€"+toString((g).price))),main_rating((g).rating))));}return main_background(newVector(main_navBar((c).headers,"CUSTOM BUILDS"),html_h1(newVector(html_style("color: white; width: 100%; text-align: center; font-size: 40px;")),(c).kind),html_input(newVector(html_style("width: 80%; margin-left: 10%; margin-right: 10%; font-size: 25px; margin-bottom: 20px; border-radius: 5px; border-width: 0px;"),html_onInput(main_search,d),html_placeHolder("search")),""),html_ul(newVector(html_class("parts")),((c).parts).map(f))));}function main_addToBuild(c, d, f,g){var l;var m;var n;var p;var q;var r;var s;var t;var k=0;return function j(h){while(1){switch(k){case 0:k=46;return main_main("CUSTOM BUILDS",j);case 46:var v=h; if (v[0]==2){m=v[1];k=48;return html_setUrl("#CUSTOM BUILDS",j);}/*case*/k=49;break;/*case*/case 48:n = (m).kinds;p = (n).map((function(w){return (w).name;}));q = (p).indexOf((c).kind);r = n.get(q);s = core_assign(r,{selected:Some(c)});t = {headers:(m).headers,kinds:(n).set(q,s)};k=50;return html_setLocalStorage((t).kinds,j);k=51;break;/*case*/case 50:h=main_PageKinds(t);k=47;/*block*/break;/*if*/case 51:/*notif*/ if (1){h=d;k=47;/*block*/break;}case 47:return g(h);}}}()}function main_singlePart(c, d){function f(g){return html_div(newVector(html_style("margin-left: 20px; position: relative;")),newVector(html_h3(newVector(html_style("font-size: 15px; color: grey; margin-bottom: 5px;")),(g).name),html_h3(newVector(html_style("font-size: 20px; color: black; margin-top: 0px;")),(g).value)));}var h;h = (c).p;return main_background(newVector(main_navBar((c).headers,"CUSTOM BUILDS"),html_span(EmptyVector,""),html_span(EmptyVector,""),html_div(newVector(html_style("margin-left: 10%; margin-right: 10%;")),newVector(html_h1(newVector(html_style("color: white; font-size: 40px; display: inline;")),(h).name),html_br(EmptyVector,""),html_div(newVector(html_style("color: gold; font-size: 40px; text-align: left; margin-left: 10px; display: inline;")),newVectorInit((h).rating,"★")),html_span(newVector(html_style("margin-left: 20px; color: white; font-size: 40px;")),toString((((("€")+(((h).price)).toString()))+("").toString()))),html_button(newVector(html_class("link"),html_onClick((main_addToBuild.bind(null,h)),d),html_style("border-radius: 5px; display: block; background-color: #6DE56A; font-size: 20px; color: white; padding: 10px; margin-top: 30px; border-width: 0px;")),"Add to build"),html_image(newVector(html_src((h).image),html_style("height: auto; width: 100%; margin-top: 5%; border-radius: 5px; padding-right: 0px;")),""),html_div(newVector(html_style("background-color: white; position: relative; border-radius: 5px; width: 100%; padding-bottom: 2px; padding-top: 3px; margin-top: 20px;")),((h).other).map(f))))));}function main_about(c){return main_background(newVector(main_navBar(main_names,"ABOUT"),html_h1(EmptyVector,"hello world!")));}function main_render(c, d){return function(){var f=c; if (f[0]==0){var g=f[1];return main_home(g,d);} if (f[0]==2){var h=f[1];return main_kinds(h,d);} if (f[0]==3){var j=f[1];return main_parts(j,d);} if (f[0]==5){var k=f[1];return main_singlePart(k,d);} if (f[0]==4){return main_about(d);} if (1){return html_h1(newVector(html_style("color: black;")),"Page not found!");}}();}function http_clientInit(){var d=0;return function c(b){while(1){switch (d){case 0:http_response = new http_Response(200,"text/plain","","");http_get = _http_get;return;}}}()}function http_Server(c){this.listen=c;}http_Server.fields=["listen"];function http_NodeHTTP(c){this.createServer=c;}http_NodeHTTP.fields=["createServer"];function http_Request(c){this.url=c;}http_Request.fields=["url"];function http_Response(c,d,f){this.status=c;this.contentType=d;this.body=f;}http_Response.fields=["status","contentType","body"];http_Response.prototype.toString=(function(){return http_Response_toString(this)});function http_Response_toString(c){return (((((((((((("Response(")+(((c).status)).toString()))+(", ").toString()))+(((c).contentType)).toString()))+(", ").toString()))+(((c).body)).toString()))+(")").toString());}function http_endResponse(c){return core_assign(http_response,{body:jsonStringify(c)});}function http_toUrl(c){return ("query/"+jsonStringify(c(http_endResponse)));}function http_query(c, d,f){var k;var l;var j=0;return function h(g){while(1){switch(j){case 0:k = http_toUrl(d);j=1;return http_get(k,h);case 1:l = ((g)).body;return f(c(l));}}}()}function db_clientInit(){var d=0;return function c(b){while(1){switch (d){case 0:return;}}}()}function db_Parts(f){return [0,f]}function db_DB(){}db_DB.fields=[];function db_Collection(c,d){this.manager=c;this.name=d;}db_Collection.fields=["manager","name"];main_clientInit();