...
else{return (main_count)[0];}})();}function main_answer(main_x){;return main_div(EmptyVector,newVector(main_h1(EmptyVector,toString(main_x)),main_h1(EmptyVector,(((("Mean ")+((main_average((main_x).map(toFloat)))).toString()))+("").toString())),main_h1(EmptyVector,(((("Median ")+((main_median((main_x).map(toFloat)))).toString()))+("").toString())),main_h1(EmptyVector,(((("Mode ")+((main_mode(main_x))).toString()))+("").toString()))));}function main_enter(main_x, main_ev,c){var g=0;return function f(d){while(1){switch(g){case 0:;return c(parseJson(core_json_vector(core_json_float),(((("[")+((((main_ev).target).value)).toString()))+("]").toString())));}}}()}main_clientInit();