...
(function e(t, n, r) {
    ...
    26: [function(require, module, exports) {
        ...
        "./hooks/attribute-hook": 20,
        "./index.js": 23,
        "./svg-attribute-namespace": 25,
        "x-is-array": 12
    }],
    ...
    39: [function(require, module, exports) {
        ...
        "has": 42,
        "isarray": 43,
        "virtual-dom/virtual-hyperscript/svg": 26,
        "xtend": 44
    }],
...
function html_clientInit() {
    var d = 0;
    return function c(b) {
        while (1) {
            switch (d) {
                case 0:
                    html_register = _html_register;
                    html_changeName = _html_changeName;
                    html__onUrlChange = _html_onUrlChange;
                    html_setUrl = _html_setUrl;
                    html_setLocalStorage = _html_setLocalStorage;
                    html_readLocalStorage = _html_readLocalStorage;
                    html_pageLoadUrl = window.location.hash.slice(1);
                    html_nextTick = _nextTick;
                    html_style = html_newAttrib.bind(null, "style");
                    html_placeHolder = html_newAttrib.bind(null, "placeholder");
                    html_position = html_newAttrib.bind(null, "position");
                    html__type = html_newAttrib.bind(null, "type");
                    html_height = html_newAttrib.bind(null, "height");
                    html_width = html_newAttrib.bind(null, "width");
                    html_id = html_newAttrib.bind(null, "id");
                    html_min = html_newAttrib.bind(null, "min");
                    html_max = html_newAttrib.bind(null, "max");
                    html_step = html_newAttrib.bind(null, "step");
                    html_value = html_newAttrib.bind(null, "value");
                    html_href = html_newAttrib.bind(null, "href");
                    html_src = html_newAttrib.bind(null, "src");
                    html_kind = html_newAttrib.bind(null, "type");
                    html__float = html_newAttrib.bind(null, "float");
                    html_class = html_newAttrib.bind(null, "className");
                    html_onClick = html_onEvent.bind(null, "onclick");
                    html_onInput = html_onEvent.bind(null, "oninput");
                    html_onChange = html_onEvent.bind(null, "onchange");
                    html_h = fromJS(html_hyper);
                    html_createElement = virtualDom.create;
                    html_diff = virtualDom.diff;
                    html_patch = toAsync(virtualDom.patch);
                    html_clear = toAsync(clearElement);
                    html_cssSelector = document.querySelector.bind(document);
                    html_h1 = html_h.bind(null, "h1");
                    html_h2 = html_h.bind(null, "h2");
                    html_h3 = html_h.bind(null, "h3");
                    html_h4 = html_h.bind(null, "h4");
                    html_h5 = html_h.bind(null, "h5");
                    html_h6 = html_h.bind(null, "h6");
                    html_br = html_h.bind(null, "br");
                    html_hr = html_h.bind(null, "hr");
                    html_button = html_h.bind(null, "button");
                    html_input = html_h.bind(null, "input");
                    html_noAttrib = EmptyVector;
                    html_div = html_h.bind(null, "div");
                    html_p = html_h.bind(null, "p");
                    html_ul = html_h.bind(null, "ul");
                    html_li = html_h.bind(null, "li");
                    html_a = html_h.bind(null, "a");
                    html_image = html_h.bind(null, "img");
                    html_span = html_h.bind(null, "span");
                    html__appendChild = toAsync(html_appendChild);
                    html_stringToH = _html_stringToH;
                    html__handle = html_handle;
                    html_animateOnVisible = html_addClassOnVisible;;
                    return;
            }
        }
    }()
...
var html_register;
var html_changeName;
var html__onUrlChange;
var html_setUrl;
var html_setLocalStorage;
var html_readLocalStorage;
var html_pageLoadUrl;
var html_nextTick;
var html_style;
...
var html_onChange;
var html_h;
var html_createElement;
var html_diff;
var html_patch;
var html_clear;
var html_cssSelector;
var html_h1;
var html_h2;
var html_h3;
var html_h4;
...
var html_image;
var html_span;
var html__appendChild;
var html_stringToH;
var html__handle;
var html_animateOnVisible;

function html_PosAtom(c, d) {
    this.a = c;
    this.pos = d;
}
html_PosAtom._fields = ["a", "pos"];
html_PosAtom.prototype.unary_read = (function(c) {
    return html_PosAtom_unary_read(this, c)
});

function html_PosAtom_unary_read(html_self, d) {
    var h = 0;
    return function g(f) {
        while (1) {
            switch (h) {
                case 0:
                    h = 1;
                    return (html_self).a.unary_read(g);
                case 1:
                    ;;
                    return d(((html_self).pos).query(f));
            }
        }
    }()
}
html_PosAtom.prototype.toString = (function() {
    return html_PosAtom_toString(this)
});

function html_PosAtom_toString(html_self) {
    var html_a;
    html_a = toString((html_self).a);
    var html_pos;
    html_pos = toString((html_self).pos);;
    return (html_a + html_pos);
}
html_PosAtom.prototype.op_set = (function(c, d) {
    return html_PosAtom_op_set(this, c, d)
});

function html_PosAtom_op_set(html_self, html_new, f) {
    var j = 0;
    return function h(g) {
        while (1) {
            switch (j) {
                case 0:
                    j = 2;
                    return (html_self).a.unary_read(h);
                case 2:
                    ;
                    j = 3;
                    return ((html_self).a).op_set(((html_self).pos).set(g, html_new), h);
                case 3:
                    ;
                    return f();
            }
...
html_PosAtom.prototype.watch = (function(c, d) {
    return html_PosAtom_watch(this, c, d)
});

function html_PosAtom_watch(html_self, html_f, f) {
    var j = 0;
    return function h(g) {
        while (1) {
            switch (j) {
                case 0:
                    function html_func(html_x, k) {
                        var n = 0;
                        return function m(l) {
                            while (1) {
                                switch (n) {
                                    case 0:
                                        n = 4;
                                        return (html_self).a.unary_read(m);
                                    case 4:
                                        ;
                                        n = 5;
                                        return html_f(((html_self).pos).query(l), m);
                                    case 5:
                                        ;
                                        return k();
                                }
                    ...
                    j = 6;
                    return ((html_self).a).watch(html_func, h);
                case 6:
                    ;
                    return f();
            }
...
function html_comp(html_func) {;
    return html_func;
}

function html_Event(c) {
    this.target = c;
}
html_Event._fields = ["target"];

function html_Attribute(c, d) {
    this.name = c;
    this.value = d;
}
html_Attribute._fields = ["name", "value"];

function html_newAttrib(html_name, html_value) {;
    return new html_Attribute(html_name, html_value, html_value);
}

function html_onEvent(html_name, html_x, html_a) {
    function html_clicked(html_e, c) {
        var html_res;
        var g = 0;
        return function f(d) {
            while (1) {
                switch (g) {
                    case 0:
                        g = 7;
                        return html_a.unary_read(f);
                    case 7:
                        ;
                        g = 8;
                        return html_x(d, html_e, f);
                    case 8:
                        html_res = d;
                        g = 9;
                        return html_register(html_x, html_a, f);
                    case 9:
                        g = 10;
                        return (html_a).op_set(html_res, f);
                    case 10:
                        ;
                        return c();
                }
    ...
    return new html_Attribute(html_name, html_clicked, html_clicked);
}

function html_onUrlChange(html_func, html_a, c) {
    var g = 0;
    return function f(d) {
        while (1) {
            switch (g) {
                case 0:
                    function html_fired(html_url, h) {
                        var html_res;
                        var l = 0;
                        return function k(j) {
                            while (1) {
                                switch (l) {
                                    case 0:
                                        l = 11;
                                        return html_a.unary_read(k);
                                    case 11:
                                        ;
                                        l = 12;
                                        return html_func(j, html_url, k);
                                    case 12:
                                        html_res = j;
                                        l = 13;
                                        return html_register(html_func, html_a, k);
                                    case 13:
                                        l = 14;
                                        return (html_a).op_set(html_res, k);
                                    case 14:
                                        ;
                                        return h();
                                }
                    ...
                    g = 15;
                    return html__onUrlChange(html_fired, f);
                case 15:
                    ;
                    return c();
            }
...
function html_async(html_x, html_a) {
    function html_fired(c) {
        var html_res;
        var g = 0;
        return function f(d) {
            while (1) {
...
function html_ignoreAct(html_name, html_f) {
    function html_func(html_x, html_y, c) {
        var g = 0;
        return function f(d) {
            while (1) {
                switch (g) {
    ...
    return html_changeName(html_func, html_name);
}

function html_withId(html_f) {
    function html_func(html_id, html_m, html_e, c) {
        var html_res;
        var g = 0;
        return function f(d) {
            while (1) {
                switch (g) {
                    case 0:
                        g = 21;
                        return html_f(html_m.get(html_id), html_e, f);
                    case 21:
                        html_res = (d);;
                        return c((html_m).set(html_id, html_res));
                }
            }
        }()
    };
...
function html_mapWithId(html_v, html_arr, html_a) {
    function html_func(html_id) {;
        return html_v(html_arr.get(html_id), html_id, html_a);
    };
    return (newVectorRange(0, (html_arr).length)).map(html_func);
}

function html_toEffect(html_name, html_f) {
    function html_func(html_x, html_ev, c) {
        var g = 0;
        return function f(d) {
            while (1) {
                switch (g) {
                    case 0:
                        ;
                        return c(html_f(html_x, html_ev));
                }
            }
        }()
    };
...
function html_mapView(html_v, html_model, html_a) {
    function html_mapper(html_idx) {
        var html_result;
        html_result = html_model.get(html_idx);
        var html_pos;
        html_pos = (newLens(function(c) {
            return c.get(html_idx)
        }, function(d, c) {
            return d.set(html_idx, c)
        }, '' + "[" + html_idx + "]"));
        var html_newA;
        html_newA = new html_PosAtom(html_a, html_pos, html_pos);;
        return html_v(html_result, html_newA);
    };
    return (newVectorRange(0, (html_model).length)).map(html_mapper);
}

function html_viewFromLens(html_v, html_model, html_pos, html_a) {;
    return html_v(((html_pos).query(html_model)), new html_PosAtom(html_a, html_pos, html_pos));
}

function html_render(html_newTree, c) {
    var html_rootNode;
    var html_root;
    var g = 0;
    return function f(d) {
        while (1) {
            switch (g) {
                case 0:
                    html_rootNode = html_createElement(html_stringToH(html_newTree));
                    html_root = html_cssSelector("#code");
                    g = 22;
                    return html__appendChild(html_root, html_rootNode, f);
                case 22:
                    ;
                    return c(html_rootNode);
            }
        }
    }()
}
...
function html_app(html_r, html_appstate, c) {
    var html_oldV;
    var html_root;
    var g = 0;
    return function f(d) {
        while (1) {
            switch (g) {
                case 0:
                    g = 23;
                    return html_appstate.unary_read(f);
                case 23:
                    ;
                    html_oldV = html_stringToH(html_r((d), html_appstate));
                    g = 24;
                    return html_get(f);
                case 24:
                    g = 25;
                    return html_render(html_oldV, f);
                case 25:
                    html_root = d;

                    function html_rerender(html_i, h) {
                        var html_newV;
                        var html_patches;
                        var l = 0;
                        return function k(j) {
                            while (1) {
                                switch (l) {
                                    case 0:
                                        html_newV = html_stringToH(html_r(html_i, html_appstate));
                                        html_patches = html_diff(html_oldV, html_newV);
                                        l = 26;
                                        return html_patch(html_root, html_patches, k);
                                    case 26:
                                        html_root = j;
                                        html__handle();
                                        html_oldV = html_newV;;
                    ...
                    g = 27;
                    return (html_appstate).watch(html_rerender, f);
                case 27:
                    ;
                    return c();
            }
    ...
    return function c(b) {
        while (1) {
            switch (d) {
                case 0:
                    html_clientInit();;
                    main_PosAtom = typeof html_PosAtom == 'undefined' || html_PosAtom;
                    main_h1 = typeof html_h1 == 'undefined' || html_h1;
                    main_id = typeof html_id == 'undefined' || html_id;
                    main_br = typeof html_br == 'undefined' || html_br;
                    main_onChange = typeof html_onChange == 'undefined' || html_onChange;
                    main_input = typeof html_input == 'undefined' || html_input;
                    main_span = typeof html_span == 'undefined' || html_span;
                    main_p = typeof html_p == 'undefined' || html_p;
                    main_button = typeof html_button == 'undefined' || html_button;
                    main_app = typeof html_app == 'undefined' || html_app;
                    main_value = typeof html_value == 'undefined' || html_value;
                    main_div = typeof html_div == 'undefined' || html_div;
                    main_style = typeof html_style == 'undefined' || html_style;
                    main_render = typeof html_render == 'undefined' || html_render;
                    main_onClick = typeof html_onClick == 'undefined' || html_onClick;
                    main_Event = typeof html_Event == 'undefined' || html_Event;
                    main_mapView = typeof html_mapView == 'undefined' || html_mapView;
                    main_toEffect = typeof html_toEffect == 'undefined' || html_toEffect;;;
                    main_unique = main_for.bind(null, ((function(main_elem, main_indiv) {;
                        return (function() {
                            if ((!((main_indiv).has(main_elem)))) {
                                return [(Some(main_elem)), (main_indiv).append(main_elem)];
                            } else {
                                return [None, main_indiv];
                            }
                        })();
                    })), EmptyVector);
                    main_sort = function(arr) {
                        return fromArray(arr.toArray().sort(function(x, y) {
                            return x > y
                        }));
                    };
                    main__console = console.log;
                    main_enter = (function(main_x, main_ev, f) {
                        var j = 0;
                        return function h(g) {
                            while (1) {
                                switch (j) {
                                    case 0:
                                        ;
                                        return f(parseJson(core_json_vector(core_json_float), (("[" + ((main_ev).target).value) + "]")));
                                }
                            }
                        }()
                    });
                    main_appState = newAtom(newVector(newVector(0.0), newVector(0.0)));
                    d = 1;
                    return main_appState.op_set(newVector(newVector(0.0)), c);
                case 1:
                    ;;
                    d = 2;
                    return main_app(main_multiple, main_appState, c);
                case 2:
                    ;
                    return;
            }
...
function main_Result(c) {
    this[0] = c
}

function main_Data(d) {
    var c = new main_Result(0);
    c[1] = d;
    return c
}
var main_Error = new main_Result(1);
main_Result.prototype.withDefault = (function(c) {
    return main_Result_withDefault(this, c)
});

function main_Result_withDefault(main_self, main_default) {;;;
    return function() {
        var d = main_self;
        if (d[0] == 0) {
            var main_x = d[1];
...
main_Result.prototype.map = (function(c) {
    return main_Result_map(this, c)
});

function main_Result_map(main_self, main_func) {;;;
    return function() {
        var d = main_self;
        if (d[0] == 0) {
            var main_x = d[1];
            return main_Data(main_func(main_x));
        }
        if (d[0] == 1) {
            return main_Error;
        }
...
function main_for(main_func, main__state, main_arr) {;;;
    var main_state;
    main_state = main__state;
    var main_new;
    main_new = EmptyVector;
    var main_length;
    main_length = (main_arr).length;
    var main_i;
    main_i = 0;
    while ((main_i < main_length)) {
        var main_tx;
        main_tx = main_func(main_arr.get(main_i), main_state);
        var main_t;
        main_t = (main_tx)[0];
        main_state = (main_tx)[1];
        main_new = function() {
            var c = main_t;
            if (c[0] == 0) {
                var main_tmp = c[1];
                return (main_new).append(main_tmp);
            }
            if (c[0] == 1) {
                return main_new;
            }
...
function main_median(main_x) {;
    var main_length;
    main_length = (main_x).length;
    var main_tmp;
    main_tmp = main_sort(main_x);;
    return (function() {
        if ((((main_length % 2) | 0) === 0)) {
            return (((main_tmp.get(((main_length / 2) | 0)) + main_tmp.get(((((main_length / 2) | 0) - 1) | 0)))) / 2.0);
        } else {
            return main_tmp.get((((((main_length - 1) | 0)) / 2) | 0));
        }
    })();
}

function main_average(main_x) {;;
    return (((main_x).reduce((op_add))) / toFloat((main_x).length));
}

function main_debug(main_x) {;
    main__console((main_x).toString());;
    return main_x;
}

function main_mode(main_x) {;
    var main_uniques;
    main_uniques = (main_unique(main_x));
    var main_u;
    main_u = (main_uniques).map((function(main_i) {;
        return [((((("") + ((main_i)).toString())) + ("").toString())), (((main_x).filter(op_eq.bind(null, main_i)))).length, 0];
    }));
    var main_count;
    main_count = (main_u).reduce((function(main_a, main_b) {;
        return (function() {
            if (((main_a)[1] > (main_b)[1])) {
                return main_a;
            } else if (((main_a)[1] === (main_b)[1])) {
                return ["b", (main_b)[1], (((main_a)[2] + 1) | 0)];
            } else {
                return main_b;
            }
        })();
    ...
    var main__;
    main__ = main_debug((main_count)[2]);;
    return (function() {
        if (((main_count)[2] === (((main_uniques).length - 1) | 0))) {
            return "n";
        } else {
            return (main_count)[0];
        }
...
function main_answer(main_x) {;;
    return main_div(EmptyVector, newVector(main_h1(EmptyVector, newVector(((((("") + ((main_x)).toString())) + ("").toString())))), main_h1(EmptyVector, newVector(((((("Mean ") + ((main_average((main_x).map(toFloat)))).toString())) + ("").toString())))), main_h1(EmptyVector, newVector(((((("Median ") + ((main_median((main_x).map(toFloat)))).toString())) + ("").toString())))), main_h1(EmptyVector, newVector(((((("Mode ") + ((main_mode(main_x))).toString())) + ("").toString()))))));
}

function main_math(main_x, main_a) {;;;
    return main_div(EmptyVector, newVector(main_input(newVector(main_onChange(main_enter, main_a), main_value(((main_x).join(",")))), EmptyVector), main_answer(main_x)));
}

function main_append(main_x, main_ev, c) {
    var g = 0;
    return function f(d) {
        while (1) {
            switch (g) {
                case 0:
                    ;;;
                    return c((main_x).append(newVector(0.0)));
            }
        }
    }()
}

function main_remove(main_x, main_ev, c) {
    var g = 0;
    return function f(d) {
        while (1) {
            switch (g) {
                case 0:
                    ;;;
                    return c((main_x).shorten(1));
            }
        }
    }()
}

function main_multiple(main_x, main_a) {;;;
    return main_div(EmptyVector, newVector(main_button(newVector(main_onClick(main_append, main_a)), newVector("Add another")), main_br(EmptyVector, EmptyVector), main_button(newVector(main_onClick(main_remove, main_a)), newVector("Remove")), main_mapView(main_math, main_x, main_a)));
}
main_clientInit();